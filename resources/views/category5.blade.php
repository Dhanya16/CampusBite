...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Juice</h1>
        <div class="container text-center">
            @php
                $juiceItems = $filteredItems->where('Category', 'Juice')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($juiceItems as $itemPair)
                <div class="row">
