...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">South Indian Snacks</h1>
        <div class="container text-center">
            @php
                $sisItems = $filteredItems->where('Category', 'South Indian Snacks')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($sisItems as $itemPair)
                <div class="row">
