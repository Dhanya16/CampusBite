...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Ice cream</h1>
        <div class="container text-center">
            @php
                $icecreamItems = $filteredItems->where('Category', 'Ice cream')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($icecreamItems as $itemPair)
                <div class="row">
