...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Chaats</h1>
        <div class="container text-center">
            @php
                $chaatsItems = $filteredItems->where('Category', 'Chaats')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($chaatsItems as $itemPair)
                <div class="row">
