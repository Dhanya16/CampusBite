            ...
            <div id="form" class='page'>
                <div class="form-box">
                    ...
                    <div id='loginid'class='login-page'>
                        ...
                        @endif
                        <form id='login' action='counter' method='POST' class='input-group-login'>
                            @csrf
                            <div class='input-box'>
                    ...
                    <div id='signupid'class='signup-page'>
                        <form id='signup' action='userSign2' method='POST' class='input-group-signup' onsubmit="return validatePassword()">
                            @csrf
                            <div class='input-box'>
