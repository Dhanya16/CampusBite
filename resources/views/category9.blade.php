...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Dosa</h1>
        <div class="container text-center">
            @php
                $dosaItems = $filteredItems->where('Category', 'Dosa')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($dosaItems as $itemPair)
                <div class="row">
