...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Chinese</h1>
        <div class="container text-center">
            @php
                $chineseItems = $filteredItems->where('Category', 'Chinese')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($chineseItems as $itemPair)
                <div class="row">
