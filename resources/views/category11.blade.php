...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Sweets</h1>
        <div class="container text-center">
            @php
                $sweetItems = $filteredItems->where('Category', 'Sweets')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($sweetItems as $itemPair)
                <div class="row">
