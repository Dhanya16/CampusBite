    ...
    <body>
        ...
        <section class="featured-categories">
            <div class="container">
                ...
                <a class="see-more text-center" href="categories" style="color:white;text-decoration:underline;">See More</a>
            </div>
        </section>
        ...
        <div class="container food-section mt-4" >
            ...
            <a class="see-more text-center" href="category1" style="color:white;text-decoration:underline;">See More</a>
        </div>
        <!--Food section ends-->
