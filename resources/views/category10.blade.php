...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Special Dosa</h1>
        <div class="container text-center">
            @php
                $sdosaItems = $filteredItems->where('Category', 'Special Dosa')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($sdosaItems as $itemPair)
                <div class="row">
