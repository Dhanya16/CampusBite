...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Meal & Pulao</h1>
        <div class="container text-center">
            @php
                $mnpItems = $filteredItems->where('Category', 'Meal & Pulao')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($mnpItems as $itemPair)
                <div class="row">
