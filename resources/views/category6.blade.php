...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Milkshakes</h1>
        <div class="container text-center">
            @php
                $mkItems = $filteredItems->where('Category', 'Milkshakes')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($mkItems as $itemPair)
                <div class="row">
