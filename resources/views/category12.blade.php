...
<html lang="en">
    ...
    <header>
        ...
        <!--Main section-->
        <h1 class="text-center" style="margin-top:5%;">Gravys</h1>
        <div class="container text-center">
            @php
                $gravysItems = $filteredItems->where('Category', 'Gravys')->where('delete', 1)->sortByDesc('created_at')->chunk(2);
            @endphp
            @foreach ($gravysItems as $itemPair)
                <div class="row">
